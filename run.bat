...
REM Download JavaFX (SDK) - Using curl for reliability
if not exist "lib\javafx-controls-17.0.2-win.jar" (
    echo Downloading JavaFX Controls Win...
    curl -L "https://repo1.maven.org/maven2/org/openjfx/javafx-controls/17.0.2/javafx-controls-17.0.2-win.jar" -o "lib\javafx-controls-17.0.2-win.jar"
)

if not exist "lib\javafx-fxml-17.0.2-win.jar" (
    echo Downloading JavaFX FXML Win...
    curl -L "https://repo1.maven.org/maven2/org/openjfx/javafx-fxml/17.0.2/javafx-fxml-17.0.2-win.jar" -o "lib\javafx-fxml-17.0.2-win.jar"
)

if not exist "lib\javafx-graphics-17.0.2-win.jar" (
    echo Downloading JavaFX Graphics Win...
    curl -L "https://repo1.maven.org/maven2/org/openjfx/javafx-graphics/17.0.2/javafx-graphics-17.0.2-win.jar" -o "lib\javafx-graphics-17.0.2-win.jar"
)

if not exist "lib\javafx-base-17.0.2-win.jar" (
    echo Downloading JavaFX Base Win...
    curl -L "https://repo1.maven.org/maven2/org/openjfx/javafx-base/17.0.2/javafx-base-17.0.2-win.jar" -o "lib\javafx-base-17.0.2-win.jar"
)
...
rem Windows separator is ; for classpath
